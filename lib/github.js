...
export async function getFileContent(owner, repo, branch, path) {
  // Encode each path segment individually — encoding the whole path at once
  // would also escape the "/" separators, breaking the URL. Segment-by-segment
  // encoding correctly handles spaces and special characters in real filenames
  // (e.g. "docs/Getting Started.md") without touching the directory structure.
